...
- Для рассылки: отправьте из админского чата `/admin`, нажмите «Создать рассылку»,
  затем введите текст (HTML/Markdown сохраняется) или пришлите фото/документ с подписью и подтвердите «Отправить».
  - Кнопка со ссылкой: `BUTTON_URL:Текст кнопки|https://example.com`
  - Кнопка, отправляющая файл: пришлите PDF с подписью `BUTTON:Текст кнопки`
